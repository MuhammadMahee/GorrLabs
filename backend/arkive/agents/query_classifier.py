...
class QueryClassification:
    ...
    domain: str = "general"  # finance|legal|hr|product|general
...
Domain (classify into exactly ONE):
- finance: queries about budgets, invoices, revenue, pricing,
           financial figures, cost, expenditure, billing
- legal: queries about NDAs, contracts, compliance, regulations,
         policies, legal agreements, liability, jurisdiction
- hr: queries about leave, hiring, onboarding, payroll,
      performance reviews, employee benefits, attendance
- product: queries about features, roadmap, technical specs,
           releases, engineering, integrations, architecture
...
Output format (strict JSON, no extra text):
{
  ...
  "domain": "finance | legal | hr | product | general",
  "confidence": 0.0-1.0,
...
async def classify_query(query: str) -> QueryClassification:
    ...
    try:
        ...
        _VALID_DOMAINS = {"finance", "legal", "hr", "product", "general"}
