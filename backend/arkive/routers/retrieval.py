...
from arkive.models.files import FileModel, FileUpdateForm, Files
from arkive.utils.access_control.files import has_access_to_file
from arkive.models.knowledge import Knowledges
from arkive.storage.provider import Storage
from arkive.internal.db import get_session, get_db
...
# Document loaders
from arkive.retrieval.loaders.main import Loader
from arkive.retrieval.loaders.youtube import YoutubeLoader

# Web search engines
from arkive.retrieval.web.main import SearchResult
from arkive.retrieval.web.utils import get_web_loader
from arkive.retrieval.web.ollama import search_ollama_cloud
from arkive.retrieval.web.perplexity_search import search_perplexity_search
from arkive.retrieval.web.brave import search_brave
from arkive.retrieval.web.kagi import search_kagi
from arkive.retrieval.web.mojeek import search_mojeek
from arkive.retrieval.web.bocha import search_bocha
from arkive.retrieval.web.duckduckgo import search_duckduckgo
from arkive.retrieval.web.google_pse import search_google_pse
from arkive.retrieval.web.jina_search import search_jina
from arkive.retrieval.web.searchapi import search_searchapi
from arkive.retrieval.web.serpapi import search_serpapi
from arkive.retrieval.web.searxng import search_searxng
from arkive.retrieval.web.yacy import search_yacy
from arkive.retrieval.web.serper import search_serper
from arkive.retrieval.web.serply import search_serply
from arkive.retrieval.web.serpstack import search_serpstack
from arkive.retrieval.web.tavily import search_tavily
from arkive.retrieval.web.bing import search_bing
from arkive.retrieval.web.azure import search_azure
from arkive.retrieval.web.exa import search_exa
from arkive.retrieval.web.perplexity import search_perplexity
from arkive.retrieval.web.sougou import search_sougou
from arkive.retrieval.web.firecrawl import search_firecrawl
from arkive.retrieval.web.external import search_external
from arkive.retrieval.web.yandex import search_yandex
from arkive.retrieval.web.ydc import search_youcom
...
from arkive.retrieval.vector.utils import filter_metadata
from arkive.utils.misc import (
...
def get_rf(
    ...
    if reranking_model:
        if any(model in reranking_model for model in ['jinaai/jina-colbert-v2']):
            try:
                from arkive.retrieval.models.colbert import ColBERT
            ...
            if engine == 'external':
                try:
                    from arkive.retrieval.models.external import ExternalReranker
    ...
    if engine == 'ollama_cloud':
        ...
        if request.app.state.config.GOOGLE_PSE_API_KEY and request.app.state.config.GOOGLE_PSE_ENGINE_ID:
            return search_google_pse(
                ...
                request.app.state.config.WEB_SEARCH_RESULT_COUNT,
                request.app.state.config.WEB_SEARCH_DOMAIN_FILTER_LIST,
                referer=request.app.state.config.ARKIVE_URL,
            )
        else:
